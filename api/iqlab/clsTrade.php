...
//   $delTapip = abs(abs($row['pip']/10) - abs($row['previousPIP']/10)) ;
   ...
   $sql="SELECT a.candleID ,b.candleID,b.minuteno, a.ema3,b.ema3, (b.ema3-a.ema3)*1000*1000 as differ
    FROM  $tableName a INNER join " .$tableName . " b on b.candleID-1 = a.candleID  WHERE b.candleID = ?";
   $params = array($row['candleID']);   
   $rowDifferEMA = pdoRowSet($sql,$params,$this->pdo) ;   
